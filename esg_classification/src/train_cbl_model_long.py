"""
This script finetunes Camembert-large model with an increased input leangth to 1024.
c.f. https://discuss.huggingface.co/t/fine-tuning-bert-with-sequences-longer-than-512-tokens/12652
Minimal complexification of the model architecture is done.
"""
...
OUTPUT_MODEL_STATE_DICT_PATH = output_directory + '/models/state_dict/cbl_model_long_sd.pt'
OUTPUT_FULL_MODEL_PATH = output_directory + '/models/full_model/cbl_model_long.pt'
...
if __name__ == "__main__":
    ...
    for _ in tqdm(range(ROUNDS)):
        ...
        model=Model1(checkpoint=MODEL_CHECKPOINT,
